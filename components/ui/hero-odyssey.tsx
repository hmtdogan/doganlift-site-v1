        ...
        <div className="relative w-full bg-black text-white overflow-hidden">
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
                ...
                <motion.div
                    ...
                    className="px-4 backdrop-blur-3xl bg-black/50 rounded-50 py-4 flex justify-between items-center mb-12 hidden"
                >
                ...
                >
                    ...
                    <motion.div variants={itemVariants}>
                        <FeatureItem name="Konfor" value="Sessiz & Seri" position="left-1/4 top-24" />
                    </motion.div>
                    <motion.div variants={itemVariants}>
                        <FeatureItem name="Teknoloji" value="İleri Mühendislik" position="right-1/4 top-24" />
                    </motion.div>
                    <motion.div variants={itemVariants}>
                        <FeatureItem name="Estetik" value="Modern Dizayn" position="right-0 sm:right-10 top-40" />
                    </motion.div>
                </motion.div>
                ...
                >                    {/* <ElasticHueSlider
                    ...
                    <Link href="/hizmetler">
                        <motion.div
                            ...
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="mt-[50px] sm:mt-[50px] px-8 py-3 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-colors cursor-pointer inline-block"
                        >
            ...
            >
                ...
                {/* Glowing circle */}
                <div className="absolute top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] rounded-full bg-blue-900/10 blur-[150px]"></div>
